    ...
    return (
        <Container style={{ maxWidth: '100%', marginTop: '0' }}> 
            <Container style={{ maxWidth: '400px', marginTop: '150px' }}>
                <h2 style={{ textAlign: 'center', marginBottom: '20px' }}>Добро пожаловать!</h2>
                <h3 style={{ textAlign: 'center', marginBottom: '20px' }}>Если у Вас уже есть аккаунт, нажмите на кнопку Войти</h3>
